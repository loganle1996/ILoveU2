...
//    Image aiHouseImage = new Image("AiHouse.png");
    ...
    public void getMapData2()
    {
        map = new String [][]{
          ...
          {"x","m"," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," ","x"},
          {"x"," "," "," "," "," "," "," ","-","-","i"," "," "," "," "," "," ","m","m","P"," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," ","x"},
          {"x","w","w","w","w","w","w","w","w","w","w","w","w","w","w","w","w","m","m","m"," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," ","x"},
          {"x","w","w","w","w","w","w","w","w","w","w","w","w","w","w","w","w","m","m","m","m"," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," ","x"},
          {"x","w","w","w","w","w","w","w","w","w","w","w","w","w","w","w","w","m","m","m","m","m"," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," ","x"},
          {"x","w","w","w","w","w","w","w","w","w","w","w","w","w","w","w","w","m","m","m","m","m","m"," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," ","x"},
        ...
        for (int i = 0; i< 1600; i++) {
            ...
            switch (stringChar) {
                ...
                case "P":
                    ...
                    player1.healAndRefill(); // for resetting map
                    player1.setIsMovingRight(false);
                    player1.setIsMovingLeft(false);
    ...
    public void changeMap(){
        ...
        if(mapId == 1){
            ...
            winBox.displayWinMessage("Victory","Congratulations, you have just accomplised all challenges of the game");
        }
        this.addAllObjectsToGameModel();
    }
